...
<p class="appointmentSchedulerDisclaimer">
    Appointments shown are dependent on practitioner selected. Please change practitioner to see different appointments.
</p>
...
<div id="appointmentSchedulerDiv">
    ...
    <form action="index.php" method="POST" class="appointmentSchedulerForm">
        ...
        <input type="text"      class="schedulerDivInput"       name="clientFirstName"   placeholder="First Name"                                                        tabIndex=1 />
        <input type="text"      class="schedulerDivInput"       name="clientLastName"    placeholder="Last Name"                                                         tabIndex=2 />
        <input type="text"      class="schedulerDivInput"       name="clientEmail"       placeholder="Email"         pattern="[A-z,0-9]{2,}@[A-z]{2,}.[A-z]{2,}"         tabIndex=3 />
        <input type="text"      class="schedulerDivInput"       name="clientPhone"       placeholder="Phone"                                                             tabIndex=4 />
        ...
        <input type="time"      class="schedulerDivInput"       name="appointmentTime" />
